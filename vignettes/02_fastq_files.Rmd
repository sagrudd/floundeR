...
Basecalled nanopore FASTQ entries can contain additional information in their
**header** fields. These metadata facets relate to the sequencing run and can
support lightweight QC review when raw-signal POD5 files are not being
inspected directly. The `fishy_fastq` method used in the previous section can
also parse these sequence metadata facets from the FASTQ file.
